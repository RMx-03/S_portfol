...
const TargetCursor = ({ targetSelector = ".cursor-target", spinDuration = 2, hideDefaultCursor = true }) => {
  ...
  useEffect(() => {
    ...
    const enterHandler = (e) => {
      ...
      const labelText = target.getAttribute("data-label")
      if (labelText) {
        showLabel(labelText)
      }
  ...
  }, [targetSelector, spinDuration, moveCursor, constants, hideDefaultCursor, showLabel, hideLabel])

  return (
    <div
      ref={cursorRef}
      className="fixed top-0 left-0 w-0 h-0 pointer-events-none z-[9999] mix-blend-normal transform -translate-x-1/2 -translate-y-1/2"
